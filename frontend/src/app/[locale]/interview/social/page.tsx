...
export default function SocialInterviewPage() {
  ...
  const features = [
    { title: t('features.logic.title'), desc: t('features.logic.desc') },
    { title: t('features.design.title'), desc: t('features.design.desc') },
    { title: t('features.communication.title'), desc: t('features.communication.desc') },
    { title: t('features.level.title'), desc: t('features.level.desc') },
  ];
