      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="text-center mb-10">
          <Title level={2} className="!text-3xl !font-bold text-slate-800 !mb-3">
            {"Comprehensive Interview"} · <span className="text-green-600">{"Campus Interview"}</span>
          </Title>
            ...
            >
              <div className="h-full flex flex-col">
                <div className="mb-6">
                  ...
                  <Text className="text-slate-400 text-sm">{"System will focus on these abilities"}</Text>
                </div>
                ...
                >
                  ...
                  >
                    <Select
                      ...
                      notFoundContent={
                        loadingResumes ? <Spin size="small" /> : "No resume detected, cannot start interview."
                      }
                  ...
                  <Form.Item
                    label={<span className="font-medium text-slate-700">{"Target Company (Optional)"}</span>}
                    name="company_name"
                    className="!mb-6"
                  >
                    <Input
