...
func registerKBGroup(group *route.RouterGroup, adminOnly bool) {
	...
	if adminOnly {
		...
		group.GET("/embedding-cache/gate", kb.GetEmbeddingCacheGate)
		group.GET("/embedding-cache/acceptance", kb.GetEmbeddingCacheAcceptance)
		group.GET("/embedding-cache/report", kb.GetEmbeddingCacheReport)
